export const education = [
  ...
  },
  {
    ...
    tags: ['GIT', 'Otros', 'Herramientas de trabajo'],
    id: '2',
  ...
  },
  {
    ...
    tags: ['Css', 'Diseño', 'FrontEnd', 'UX/UI', 'Web Design'],
    id: '4',
  ...
  },
  {
    ...
    tags: ['Javascript', 'FrontEnd', 'DOM', 'HTML', 'CSS', 'Web Design'],
    id: '8',
  ...
  {
    title: 'HTML & CSS',
    subtitle: 'Curso HTML & CSS OpenBootcamp',
    skills_learned: [
    ...
    professor: null,
    hours: null,
    certification: '/certifications/html-css-certification.pdf',
    type: 'COURSE',
    image: '/educationImg/htmlcss.png',
    tags: ['HTML', 'CSS', 'Web Design'],
    id: '17',
    url_certification: '/certifications/html-css-certification.pdf',
    coursed_in: 'OpenBootcamp',
  },
  {
    title: 'React básico',
    subtitle: 'Curso React Avanzado - OpenBootcamp',
    skills_learned: [
      'Componentes y jerarquía',
      'Hooks',
      'Depuracion de codigo',
      'Gestión avanzada de rutas en React JS',
      'Gestionando el estado con Hooks',
      'Introducción a Webpack y configuración',
    ],
    professor: 'Martín San José de Vicente',
    hours: 30,
    certification: '/certifications/react-intermediate-certification.pdf',
    type: 'COURSE',
    image: '/educationImg/reactbs.png',
    tags: ['ReactJs', 'FrontEnd'],
    id: '18',
    url_certification: '/certifications/react-intermediate-certification.pdf',
    coursed_in: 'OpenBootcamp',
  },
  {
    ...
    skills_learned: [
      ...
      'Docker y ReactJS',
      'Firebase',
      'Testing en ReactJS + TDD con Jest',
      'Testing e2e con Cypress',
      'Arquitectura',
      'React JS con TypeScript',
    ],
    professor: 'Gorka Villar',
    hours: 30,
    certification: '/certifications/react-upper-certification.pdf',
    type: 'COURSE',
    image: '/educationImg/reactav.png',
    tags: ['ReactJs', 'FrontEnd', 'Typescript'],
    id: '19',
    url_certification: '/certifications/react-upper-certification.pdf',
    coursed_in: 'OpenBootcamp',
  },
];
